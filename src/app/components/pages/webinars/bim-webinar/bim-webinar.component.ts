...
@Component({
  selector: 'app-bim-webinar',
  templateUrl: './bim-webinar.component.html',
  styleUrls: ['./bim-webinar.component.scss'],
})
export class BimWebinarComponent {
    ...
    this.http
      ...
      .subscribe(
        (response) => {
          ...
          this.router.navigate(['/thankyou-bim']);
          // window.open('https://teksacademylms.graphy.com/courses/Free-Webinar-on-BIM-65687b7fe4b0cad9d0f18a79', '_blank');
          this.resetForm();
        },
        (error) => {
