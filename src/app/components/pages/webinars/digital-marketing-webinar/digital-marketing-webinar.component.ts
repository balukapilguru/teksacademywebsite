...
@Component({
  selector: 'app-digital-marketing-webinar',
  templateUrl: './digital-marketing-webinar.component.html',
  styleUrls: ['./digital-marketing-webinar.component.scss'],
})
export class DigitalMarketingWebinarComponent {
  ...
  sccourse: string = 'DIGITAL MARKETING';
  screferedby: string = '';
  ...
  scFormSubmit() {
    ...
    //   return;
    // }
    // "https://demo.teksacademy.com:3000/webinars"
    this.http
      ...
      .subscribe(
        (response) => {
          ...
          this.router.navigate(['/thankyou-digital-marketing']);
          // window.open('https://teksacademylms.graphy.com/courses/Free-Webinar-on-Digital-Marketing-65687446e4b0d70ad896c35f', '_blank');
          this.resetForm();
        },
        (error) => {
