...
@Component({
  selector: 'app-salesforce-webinar',
  templateUrl: './salesforce-webinar.component.html',
  styleUrls: ['./salesforce-webinar.component.scss'],
})
export class SalesforceWebinarComponent {
    ...
    this.http
      ...
      .subscribe(
        (response) => {
          ...
          this.router.navigate(['/thankyou-salesforce']);
          // window.open('https://teksacademylms.graphy.com/courses/Free-Webinar-on-Salesforce-65687dbbe4b038a0b2d81c05', '_blank');
          this.resetForm();
        },
        (error) => {
