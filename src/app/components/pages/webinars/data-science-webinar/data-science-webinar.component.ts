...
export class DataScienceWebinarComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Learn Best Data Science Course in Hyderabad - Teks academy'
    );
    ...
    this.metaService.addTag({
      name: 'description',
      content:
        'SEO is a part of Data Science and Teks academy provides in-depth knowledge of Search engine optimization courses in Hyderabad to become an expert in SEO.',
    });
    ...
    this.http
      ...
      .subscribe(
        (response) => {
          ...
          this.router.navigate(['/thankyou-data-science']);
          // window.open('https://teksacademylms.graphy.com/courses/Free-Webinar-on-Data-Science-656869bbe4b0d70ad896ba50', '_blank');
          this.resetForm();
        },
        (error) => {
