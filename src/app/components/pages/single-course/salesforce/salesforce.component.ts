...
export class SalesforceComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Salesforce CRM Training course | online & In-person | Hyderabad'
    );
...
"image": " https://teksacademy.com/assets/img/allcourses/Salesforce.jpg ",

"description": " Join the best Salesforce CRM course in Hyderabad, a training program designed with an industry-relevant curriculum and conducted classes by qualified trainers. ",
...
"reviewBody": " The Salesforce Associate course from this Academy is excellent for beginners. The instructor is knowledgeable, and the content is well-explained and easy to follow. ",
