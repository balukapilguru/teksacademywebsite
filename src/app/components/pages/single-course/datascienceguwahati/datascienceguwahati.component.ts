...
@Component({
  selector: 'app-datascienceguwahati',
  templateUrl: './datascienceguwahati.component.html',
  styleUrls: ['./datascienceguwahati.component.scss']
})
export class DatascienceguwahatiComponent {
  ...
  private addJsonLdScript() {
    if (!document.getElementById(this.jsonLdScriptId)) {
      ...
      script.text = `
      {
        ...
        "description": "Join the Data Science Certification Course and upskill yourself with fast-track. Join today to get the Best Data Science course in Hyderabad at Teks Academy",
          "mpn": "001",
        "sku": "1800-120-4748",
        "brand": {
          "@type": "brand",
