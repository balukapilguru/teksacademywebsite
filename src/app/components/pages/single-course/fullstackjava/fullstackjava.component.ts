...
@Component({
  selector: 'app-fullstackjava',
  templateUrl: './fullstackjava.component.html',
  styleUrls: ['./fullstackjava.component.scss'],
})
export class FullstackjavaComponent {
...
"@type": "Review", "name": "Kandula Neha ",

"reviewBody": " I have enrolled for Java full stack. The knowledge given by the trainer is very helpful to me. I feel this is the best place to pursue this course. My all over experience is very good. Thank you Teks Academy.",
