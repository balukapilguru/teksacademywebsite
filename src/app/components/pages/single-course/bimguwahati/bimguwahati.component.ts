...
@Component({
  selector: 'app-bimguwahati',
  templateUrl: './bimguwahati.component.html',
  styleUrls: ['./bimguwahati.component.scss']
})
export class BimguwahatiComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Best BIM Training Institute in Hyderabad'
    );
...
"reviewBody": " I'm Rehan i got great experience with Teks academy i have learned BIM, AutoCAD and very good support from teaching staff management all are cooperative ",
