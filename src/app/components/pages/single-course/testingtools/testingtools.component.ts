...
@Component({
  selector: 'app-testingtools',
  templateUrl: './testingtools.component.html',
  styleUrls: ['./testingtools.component.scss'],
})
export class TestingtoolsComponent {
...
"image": " https://teksacademy.com/assets/img/allcourses/Testing_Tools.png ",

"description": " Learn the Best Testing Tools Course in Hyderabad from Teks Academy and become an expert, with the benefits of Placement assistance, and 100% job support ",
...
"reviewBody": " I recently finished the Testing Tools course, and I'm thoroughly impressed! The instructors did an excellent job covering various testing tools, and the hands-on experience was invaluable. This course is a must for anyone looking to excel in software testing ",
