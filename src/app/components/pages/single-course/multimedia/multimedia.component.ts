...
export class MultimediaComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Best Multimedia Animation Course in Hyderabad'
    );
...
"image": " https://teksacademy.com/assets/img/allcourses/multimedia.png ",

"description": " Discover the exciting world of multimedia animation course with topics ranging from 2D to 3D animation, character design, motion graphics, and more. ",
...
"reviewBody": " Just completed the Multimedia course at Teks Academy, and it was fantastic! The lecturers provided extensive training in graphic design, video editing, and other areas. I learned essential skills and really enjoyed the hands-on tasks. I highly suggest this course to anyone interested in multimedia. ",
