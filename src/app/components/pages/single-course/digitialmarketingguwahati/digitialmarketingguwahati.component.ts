...
@Component({
  selector: 'app-digitialmarketingguwahati',
  templateUrl: './digitialmarketingguwahati.component.html',
  styleUrls: ['./digitialmarketingguwahati.component.scss']
})
export class DigitialmarketingguwahatiComponent {
