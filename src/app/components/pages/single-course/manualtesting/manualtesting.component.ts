...
export class ManualtestingComponent {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      'Manual Testing course training in Hyderabad - Teks Academy'
    );
    ...
    this.metaService.addTag({
      name: 'description',
      content:
        'Looking to Build your carrier in Manual Testing. Upgrade your skills and get trained by experts in Manual Testing course training in Hyderabad. - Teks Academy',
    });
